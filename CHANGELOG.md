...
## [1.5.0](https://github.com/jurislm/judicial-mcp/compare/v1.4.0...v1.5.0) (2026-06-24)
...
* **openspec:** address CodeRabbit review comments ([b7956a2](https://github.com/jurislm/judicial-mcp/commit/b7956a27e075954472833ddc27e94239d6db2051))
* **openspec:** correct spec inaccuracies found in code review ([7c1fde1](https://github.com/jurislm/judicial-mcp/commit/7c1fde121bec98f82989cfb061e479412de4d0de))
* **review:** address all 8 code review findings from PR [#10](https://github.com/jurislm/judicial-mcp/issues/10) ([a9edc20](https://github.com/jurislm/judicial-mcp/commit/a9edc206585094024a02888cedbc5e515b813beb))
* **server:** add safe serialization fallback + hasOwnProperty tool check ([63f1e1b](https://github.com/jurislm/judicial-mcp/commit/63f1e1b70da119ca373989cc59b0561f8fbf9fb6))
* **tools:** strip content-type charset params before using as mimeType ([f5523dc](https://github.com/jurislm/judicial-mcp/commit/f5523dc863dd14598a0fc8f449fb05b03eac9317))
...
* **openspec:** archive typescript-migration + sync live specs to TypeScript source ([93512db](https://github.com/jurislm/judicial-mcp/commit/93512db1634f7354674d6cb01a18ba6b60f1985e))
* **openspec:** archive typescript-migration change + sync live specs to .ts ([c21a2f3](https://github.com/jurislm/judicial-mcp/commit/c21a2f30772b2ad5dfbb144674fe0a6f5e4ed896))
* **openspec:** tighten routing spec to match content[0].type === 'resource' condition ([851259e](https://github.com/jurislm/judicial-mcp/commit/851259ef55928076c2229c7b6ce4dd5177bfe4f5))
* **openspec:** update design.md D3 to reflect moduleResolution: bundler ([b15fabf](https://github.com/jurislm/judicial-mcp/commit/b15fabf593a30d495b17cbf164f0c632c4e36275))
